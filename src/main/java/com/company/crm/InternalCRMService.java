...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.20.0)", date = "2024-11-18")
@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
public class InternalCRMService {

  public interface Iface {

    public java.util.List<InternalLeadDto> findLeads(double lowAnnualRevenue, double highAnnualRevenue, String state) throws org.apache.thrift.TException;

    public java.util.List<InternalLeadDto> findLeadsByDate(String startDate, String endDate) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void findLeads(double lowAnnualRevenue, double highAnnualRevenue, String state, org.apache.thrift.async.AsyncMethodCallback<java.util.List<InternalLeadDto>> resultHandler) throws org.apache.thrift.TException;

    public void findLeadsByDate(String startDate, String endDate, org.apache.thrift.async.AsyncMethodCallback<java.util.List<InternalLeadDto>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_findLeads(double lowAnnualRevenue, double highAnnualRevenue, String state) throws org.apache.thrift.TException
    {
    ...
    public void send_findLeadsByDate(String startDate, String endDate) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class findLeads_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<InternalLeadDto>> {
      ...
      public findLeads_call(double lowAnnualRevenue, double highAnnualRevenue, String state, org.apache.thrift.async.AsyncMethodCallback<java.util.List<InternalLeadDto>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class findLeadsByDate_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<InternalLeadDto>> {
      ...
      public findLeadsByDate_call(String startDate, String endDate, org.apache.thrift.async.AsyncMethodCallback<java.util.List<InternalLeadDto>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class findLeads_args implements org.apache.thrift.TBase<findLeads_args, findLeads_args._Fields>, java.io.Serializable, Cloneable, Comparable<findLeads_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable String state; // required
    ...
    public findLeads_args setState(@org.apache.thrift.annotation.Nullable String state) {
      this.state = state;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case LOW_ANNUAL_REVENUE:
        if (value == null) {
          ...
          setLowAnnualRevenue((Double)value);
        }
        break;
      ...
      case HIGH_ANNUAL_REVENUE:
        if (value == null) {
          ...
          setHighAnnualRevenue((Double)value);
        }
        break;
    ...
    public int compareTo(findLeads_args other) {
      ...
      lastComparison = Boolean.compare(isSetLowAnnualRevenue(), other.isSetLowAnnualRevenue());
      if (lastComparison != 0) {
      ...
      lastComparison = Boolean.compare(isSetHighAnnualRevenue(), other.isSetHighAnnualRevenue());
      if (lastComparison != 0) {
        return lastComparison;
      }
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("findLeads_args(");
      boolean first = true;
  ...
  public static class findLeads_result implements org.apache.thrift.TBase<findLeads_result, findLeads_result._Fields>, java.io.Serializable, Cloneable, Comparable<findLeads_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("findLeads_result(");
      boolean first = true;
  ...
  public static class findLeadsByDate_args implements org.apache.thrift.TBase<findLeadsByDate_args, findLeadsByDate_args._Fields>, java.io.Serializable, Cloneable, Comparable<findLeadsByDate_args>   {
    ...
    public findLeadsByDate_args setStartDate(@org.apache.thrift.annotation.Nullable String startDate) {
      this.startDate = startDate;
      return this;
    }
    ...
    public findLeadsByDate_args setEndDate(@org.apache.thrift.annotation.Nullable String endDate) {
      this.endDate = endDate;
      return this;
    }
    ...
    public int compareTo(findLeadsByDate_args other) {
      ...
      lastComparison = Boolean.compare(isSetStartDate(), other.isSetStartDate());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetStartDate()) {
      ...
      lastComparison = Boolean.compare(isSetEndDate(), other.isSetEndDate());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetEndDate()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("findLeadsByDate_args(");
      boolean first = true;
  ...
  public static class findLeadsByDate_result implements org.apache.thrift.TBase<findLeadsByDate_result, findLeadsByDate_result._Fields>, java.io.Serializable, Cloneable, Comparable<findLeadsByDate_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("findLeadsByDate_result(");
      boolean first = true;
  ...
  public static class deleteLead_args implements org.apache.thrift.TBase<deleteLead_args, deleteLead_args._Fields>, java.io.Serializable, Cloneable, Comparable<deleteLead_args>   {
    ...
    public int compareTo(deleteLead_args other) {
      ...
      lastComparison = Boolean.compare(isSetLead(), other.isSetLead());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetLead()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("deleteLead_args(");
      boolean first = true;
...
;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("deleteLead_result(");
      boolean first = true;
  ...
  public static class addLead_args implements org.apache.thrift.TBase<addLead_args, addLead_args._Fields>, java.io.Serializable, Cloneable, Comparable<addLead_args>   {
    ...
    public int compareTo(addLead_args other) {
      ...
      lastComparison = Boolean.compare(isSetLeadDto(), other.isSetLeadDto());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetLeadDto()) {
